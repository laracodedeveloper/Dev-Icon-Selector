    ...
    class ReduxFramework_dev_iconselect extends ReduxFramework {
        ...
        public function render() {
            ...
            if(is_null($this->field['options']['icons_link']) && is_null($this->field['options']['icons_link_url'])){
                _e('Please assign icons_link, icons_link_url');
                die();
            }
                    ...
                    $output .= '<ul>';
                        ...
                        if(is_array($icon_name) && !empty($icon_name)):
                            foreach($icon_name as $key => $ic):
                                $output .= '<li title="'.$ic.'" class="dev-'.$i.' '.$this->checkActive($key, $this->value).' " data-class-name="'.$this->field['options']['class'].'" data-suffix="'.$this->field['options']['suffix'].'" data-container-name="'.$this->field['name'] . $this->field['name_suffix'].'['.strtolower($key).']" data-title="'.ucfirst($ic).'" data-name="'.strtolower($key).'" data-id="'.$i.'" data-url="'.$this->field['options']['url'].'" data-color="'.$this->field['options']['color'].'" data-hover="'.$this->field['options']['hover'].'" data-background="'.$this->field['options']['background'].'" data-background-hover="'.$this->field['options']['background-hover'].'">';
                            ...
                            $output .= '<li id="social-'.$icon['font-id'].'" class="clearfix">';
                                ...
                                $output .= '<div class="dev-icon-wrapper clearfix">';
                                    $output .= '<div class="dev-icon-link-url">';
                                        $output .= '<label class="dev-icon-url-label">'.__('Link URL', 'devthemes').'</label>';
                                        $output .= '<input class="dev-icon-url-text" type="text" value="'.$icon['font-url'].'">';
                                    $output .= '</div>';

                                    $output .= '<div class="dev-icon-text-color">';
                                        $output .= '<label class="dev-icon-color-label">'.__('Color', 'devthemes').'</label>';
                                        $output .= '<input class="dev-icon-color-picker dev-iconselect dev-iconselect-colors" type="text" value="'.$icon['font-color'].'" data-dev-default="'.$icon['font-color'].'">';
                                    $output .= '</div>';

                                    $output .= '<div class="dev-icon-text-color">';
                                        $output .= '<label class="dev-icon-color-label">'.__('Hover', 'devthemes').'</label>';
                                        $output .= '<input class="dev-icon-color-picker dev-iconselect dev-iconselect-hover" type="text" value="'.$icon['font-hover'].'" data-dev-default="'.$icon['font-hover'].'">';
                                    $output .= '</div>';

                                    $output .= '<div class="dev-icon-background-color">';
                                        $output .= '<label class="dev-icon-background-label">'.__('BG', 'devthemes').'</label>';
                                        $output .= '<input class="dev-icon-background-picker dev-iconselect dev-iconselect-background" type="text" value="'.$icon['font-background'].'" data-dev-default="'.$icon['font-background'].'">';
                                    $output .= '</div>';

                                    $output .= '<div class="dev-icon-background-color-hover">';
                                        $output .= '<label class="dev-icon-background-label">'.__('BG Hover', 'devthemes').'</label>';
                                        $output .= '<input class="dev-icon-background-picker dev-iconselect dev-iconselect-background-hover" type="text" value="'.$icon['font-background-hover'].'" data-dev-default="'.$icon['font-background-hover'].'">';
                                    $output .= '</div>';
                                ...
                                $output .= '<input type="hidden" id="font-color" name="'.$this->field['name'] . $this->field['name_suffix'].'['.$icon['font-icon'].'][font-color]" value="'.$icon['font-color'].'">';
                                $output .= '<input type="hidden" id="font-hover" name="'.$this->field['name'] . $this->field['name_suffix'].'['.$icon['font-icon'].'][font-hover]" value="'.$icon['font-hover'].'">';
                                $output .= '<input type="hidden" id="font-background" name="'.$this->field['name'] . $this->field['name_suffix'].'['.$icon['font-icon'].'][font-background]" value="'.$icon['font-background'].'">';
                                $output .= '<input type="hidden" id="font-background-hover" name="'.$this->field['name'] . $this->field['name_suffix'].'['.$icon['font-icon'].'][font-background-hover]" value="'.$icon['font-background-hover'].'">';
                ...
                $output .= '<script type="text/template" id="dev-icon-box-template">';
                    $output .= '<li id="social-<%=id %>" class="<%=classn %> clearfix">';
                        ...
                        $output .= '<div class="dev-icon-wrapper clearfix">';
                            ...
                            $output .= '<div class="dev-icon-text-color">';
                                $output .= '<label class="dev-icon-color-label">'.__('Color', 'devthemes').'</label>';
                                $output .= '<input class="dev-icon-color-picker dev-iconselect dev-iconselect-colors" type="text" value="<%=color %>" data-dev-default="<%=color %>">';
                            $output .= '</div>';

                            $output .= '<div class="dev-icon-text-color">';
                                $output .= '<label class="dev-icon-color-label">'.__('Hover', 'devthemes').'</label>';
                                $output .= '<input class="dev-icon-color-picker dev-iconselect dev-iconselect-hover" type="text" value="<%=hover %>" data-dev-default="<%=hover %>">';
                            $output .= '</div>';

                            $output .= '<div class="dev-icon-background-color">';
                                $output .= '<label class="dev-icon-background-label">'.__('BG', 'devthemes').'</label>';
                                $output .= '<input class="dev-icon-background-picker dev-iconselect dev-iconselect-background" type="text" value="<%=background %>" data-dev-default="<%=background %>">';
                            $output .= '</div>';

                            $output .= '<div class="dev-icon-background-color-hover">';
                                $output .= '<label class="dev-icon-background-label">'.__('BG Hover', 'devthemes').'</label>';
                                $output .= '<input class="dev-icon-background-picker dev-iconselect dev-iconselect-background-hover" type="text" value="<%=bhover %>" data-dev-default="<%=bhover %>">';
                            $output .= '</div>';
                        ...
                        $output .= '<input type="hidden" id="font-color" name="<%=hidden %>[font-color]" value="<%=color %>">';
                        $output .= '<input type="hidden" id="font-hover" name="<%=hidden %>[font-hover]" value="<%=hover %>">';
                        $output .= '<input type="hidden" id="font-background" name="<%=hidden %>[font-background]" value="<%=background %>">';
                        $output .= '<input type="hidden" id="font-background-hover" name="<%=hidden %>[font-background-hover]" value="<%=bhover %>">';
        ...
        public function enqueue() {
            ...
            wp_enqueue_style( 'redux-field-dev-iconselect-spectrum-css', 
                $this->extension_url . 'plugins/spectrum/spectrum.css',
                time(),
                true 
            );

             wp_enqueue_script(
                'redux-field-dev-iconselect-spectrum-js', 
                $this->extension_url . 'plugins/spectrum/spectrum.js', 
                array( 'jquery' ),
                time(),
                true
            );
